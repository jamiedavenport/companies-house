---
"@jxdltd/companies-house": minor
---

Regenerate the client from a new OpenAPI 3.1 spec built from the live Developer Hub documentation and Companies House's own SDK, replacing the repaired upstream Swagger 2.0 spec. All 34 method names are unchanged. Types are substantially more complete and correct:
